...
import { BookOpen, Globe, ClipboardList, CheckCircle, ChevronDown, FileText, Signpost } from "lucide-react";
...
const CATEGORIES: { key: Category; label: string; visible: number[]; comingSoon: number[] }[] = [
  ...
  { key: "stormwater", label: "Stormwater Training", visible: [0, 1, 2, 3], comingSoon: [] },
    ...
    <main className="min-h-screen" style={{ background: C.lightGray, fontFamily: "Calibri, 'Trebuchet MS', Arial, sans-serif" }}>
      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-4">
        {CATEGORIES.map((cat, ci) => {
          ...
          const isEmpty = cat.visible.length === 0 && cat.comingSoon.length === 0 && cat.key !== "advanced";
